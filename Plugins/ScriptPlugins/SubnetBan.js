...
const plugin = {
    ...
    interactions: [{
        ...
        action: function(_, __, ___) {
            ...
            const clientNs = importNamespace('Data.Models.Client');
            const interfaceNs = importNamespace('SharedLibraryCore.Interfaces');
            ...
            interactionData.minimumPermission = 3//clientNs.Client.Permission.Moderator;
            interactionData.interactionType = 2;//interfaceNs.InteractionType.TemplateContent;
